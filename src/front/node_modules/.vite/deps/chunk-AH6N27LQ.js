...
var PickerAdapterContext = React27.createContext(null);
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = React27.useContext(PickerAdapterContext) ?? {
    utils: void 0,
    adapter: void 0,
    localeText: void 0
  };
  ...
  const localeText = React27.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const adapter = React27.useMemo(() => {
    if (!DateAdapter) {
      if (parentAdapter) {
...
`));
  ...
  const defaultDates = React27.useMemo(() => {
    if (!adapter) {
      return null;
    }
    return {
  ...
  return (0, import_jsx_runtime19.jsx)(PickerAdapterContext.Provider, {
    value: contextValue,
    children
  });
};
...
true ? LocalizationProvider.propTypes = {
   ...
   */
  adapterLocale: import_prop_types19.default.any,
  children: import_prop_types19.default.node,
  /**
   * Date library adapter class function.
   * @see See the localization provider {@link https://mui.com/x/react-date-pickers/quickstart/#integrate-provider-and-adapter date adapter setup section} for more details.
   */
  dateAdapter: import_prop_types19.default.func,
  /**
   * Formats that are used for any child pickers
   */
  dateFormats: import_prop_types19.default.shape({
    dayOfMonth: import_prop_types19.default.string,
    dayOfMonthFull: import_prop_types19.default.string,
    fullDate: import_prop_types19.default.string,
    fullTime12h: import_prop_types19.default.string,
    fullTime24h: import_prop_types19.default.string,
    hours12h: import_prop_types19.default.string,
    hours24h: import_prop_types19.default.string,
    keyboardDate: import_prop_types19.default.string,
    keyboardDateTime12h: import_prop_types19.default.string,
    keyboardDateTime24h: import_prop_types19.default.string,
    meridiem: import_prop_types19.default.string,
    minutes: import_prop_types19.default.string,
    month: import_prop_types19.default.string,
    monthShort: import_prop_types19.default.string,
    normalDate: import_prop_types19.default.string,
    normalDateWithWeekday: import_prop_types19.default.string,
    seconds: import_prop_types19.default.string,
    shortDate: import_prop_types19.default.string,
    weekday: import_prop_types19.default.string,
    weekdayShort: import_prop_types19.default.string,
    year: import_prop_types19.default.string
  }),
  /**
   ...
   * ```
   */
  dateLibInstance: import_prop_types19.default.any,
  /**
...
//# sourceMappingURL=chunk-AH6N27LQ.js.map
